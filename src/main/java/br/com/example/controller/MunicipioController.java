...
public class MunicipioController {
    ...
    @GetMapping("/municipiosEstado/{estado}")
    public List<Municipio> municipiosEstado(@PathVariable String estado){ 
        List<Municipio> result = repository.municipiosEstado(estado); 
        return result;
    }
}